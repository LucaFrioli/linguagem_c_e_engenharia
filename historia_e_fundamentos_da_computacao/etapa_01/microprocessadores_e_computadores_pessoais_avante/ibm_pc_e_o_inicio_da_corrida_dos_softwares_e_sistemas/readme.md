...
Se hà um comprometimento para além do óbvio, e você chegou até aqui, minimamente quer dizer que não está acomodado com sua situação como desenvolvedor ou desenvolvedora, então na próxima etapa antes mesmo de nos aprofundarmos em linguagens de progrmação, iremos pincelar, as teorias que fazem parte da verdadeira evolução tecnológica, tornando-nos mais que simples progrmadores, mas sim ciêntistas e engenheiros de softwares, dispostos a estar na vanguarda das inovações. Mesmo que isso queira dizer retornar um pouco nos fundamentos essenciais, do pensamento ciêntífico, e despertar o lado explorador que está dentro de nós. Para isso [clique aqui, e vamos continuar esta jornada!](../../teorias_mais_importantes_para_a_computação_hoje/readme.md)
